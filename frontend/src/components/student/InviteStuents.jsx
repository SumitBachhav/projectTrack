...
const InviteStudents = () => {
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                const { data } = await axios.get('/api/v1/student/getProjectAndStudentData');
    ...
    const handleSendInvite = async () => {
        ...
        try {
            const response = await axios.post('/api/v1/student/sendInvitations', { studentIds: selectedStudentIds });
