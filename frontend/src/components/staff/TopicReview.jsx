          ...
          {items.map((item) => (
            <li
              ...
              className={`p-4 rounded-lg cursor-pointer transition-all ${
                selectedItem === item.stdAbsId ? "bg-blue-500 text-white" : "bg-gray-200 hover:bg-gray-300"
              }`}
            >
              {item.title}
            </li>
        ...
        <ul className="space-y-3">
          {items.map((item) => (
            <li
              ...
              className={`p-4 rounded-lg cursor-pointer transition-all ${
                approvedList.includes(item.stdAbsId) ? "bg-green-500 text-white" : "bg-gray-200 hover:bg-gray-300"
              }`}
            >
              {item.title}
            </li>
